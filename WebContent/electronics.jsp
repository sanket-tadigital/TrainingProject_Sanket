	...
	<div class="container-fluid">
				...
				<div class="collapse navbar-collapse navbar1"
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
							...
							<ul
								class="dropdown-menu multi-column dropdown-menu-center columns-3">
								<div class="row">
									<div class="col-md-3">
										<ul class="multi-column-dropdown">
						...
						<li class="dropdown">
							...
							<ul
								class="dropdown-menu dropdown-menu-center multi-column columns-3">
								<div class="row">
									<div class="col-md-3">
										<ul class="multi-column-dropdown">
		...
		<div class="row row3"
			...
			<div class="col-md-4 ccrr">
				<h5>
					<a class="links">HOME/ ELECTRONICS</a> / MOBILES
				</h5>
				<br>
			</div>
			<!-- COL2 ENDS -->
		...
		<div class="row">
			...
			<h4 class="sh_txt">
				<b>Exclusive Offers<br></b>
			</h4>
			<hr class="hrrule9 sh_txt">

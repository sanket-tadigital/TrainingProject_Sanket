	 				...
	 				<p class="lbl4">
						...
						<div class="row">
	 					...
	 					<div class="row">
	 						...
	 						<div class="col-md-12 cc">
	 							<br>
	 							<button type="submit" class="btn btn-default sub"><span class="glyphicon glyphicon-floppy-disk"></span>&nbsp;&nbsp;SAVE MY PASSWORD</button>
	 							<br>
	 							<hr>
	 						</div>
						...
						<div class="row mrgrey">
	 					...
	 					<div class="row mrgrey">
	 							...
	 							<div class="col-md-12">
	 								Address<br>
	 								<textarea class="form-control" size="100"></textarea><br>
	 							</div>
	 							<!-- INNER COL1 ENDS -->
						...
						<div class="row mrgrey">
	 					...
	 					<div class="row">
	 						...
	 						<div class="col-md-12 cc">
	 							<br>
	 							<button type="submit" class="btn btn-default sub"><span class="glyphicon glyphicon-floppy-disk"></span>&nbsp;&nbsp;SAVE CHANGES</button>
	 							<br>
	 							<hr>
	 						</div>

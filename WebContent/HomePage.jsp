...
<body>
	...
	<div class="container-fluid">
		...
		<!-- ROW1 STARTS -->
			...
			if(check!=null) {
				if(check.equals("successvlogin")) {
					session.setAttribute("filenames","DashBoard-My Products");
				} else if(check.equals("successlogin")) {
					session.setAttribute("filenames","My Account-My Orders");
				}
			}
	...
	<br>
		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="card">
					<div class="card-body text-center borman">
						<img
							src="images/images/helkin-3-m-ss18-9-adidas-mysink-cblack-reagol-original-imaf2yznwyqzdzmd.jpeg"
							class="pro1">
						<p class="card-text">
							<b>Men's Footwear</b>
						</p>
			...
			<div class="col-md-2">
				<div class="card">
					<div class="card-body text-center borman">
						<img
							src="images/images/rsc0274-10-red-tape-blue-original-imaextu5n84xxhsc.jpeg"
							class="pro1">
						<p class="card-text">
							<b>Adidas,Rebook & Puma</b>
						</p>
			...
			<div class="col-md-2">
				<div class="card">
					<div class="card-body text-center borman">
						<img
							src="images/images/hp-entry-level-backpack-nec-hp-s-8-laptop-backpack-hp-original-imaet3zhgzfnd7tz.jpeg"
							class="pro1">
						<p class="card-text">
							<b>Laptop Bag</b>
						</p>
			...
			<div class="col-md-2">
				<div class="card">
					<div class="card-body text-center borman">
						<img
							src="images/images/samsung-mb-mc32ga-in-original-imaet6za3yhhdq4z.jpeg"
							class="pro2">
						<p class="card-text">
							<b>Memory Cards...</b>
						</p>
			...
			<div class="col-md-2">
				<div class="card">
					<div class="card-body text-center borman">
						<img
							src="images/images/tw00zr250-timex-original-imaf8wsejechwcfd.jpeg"
							class="pro1">
						<p class="card-text">
							<b>Timex Maxima...</b>
						</p>
			...
			<div class="col-md-2">
				<div class="card">
					<div class="card-body text-center borman">
						<img
							src="images/images/amt-scamp-daypck01-blu-yellow-fi4-0-01-001-backpack-american-original-imaf7e42eyyzx4hb.jpeg"
							class="pro1">
						<p class="card-text">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="card">
					<div class="card-body text-center">
						<img src="images/images/61b583.jpg" class="pro3"> <br>
						<br>
					</div>
			...
			<div class="col-md-3">
				<div class="card">
					<div class="card-body text-center">
						<img src="images/images/7194c7.jpg" class="pro3"> <br>
						<br>
					</div>
		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="card">
					<div class="card-body text-center borman">
						<br> <img
							src="images/images/realme-2-rmx805-original-imaf9sn9szzvzsyu.jpeg"
							class="pro4"> <br> <br>
						<p class="card-text">
							<b>Realme 2</b>
						</p>
